...
public class GuiDemo extends JFrame{
    ...
    private JCheckBoxMenuItem gradientOverlayCheckbox = new
            JCheckBoxMenuItem("Gradient Overlay", true);
    /**
     * The constructor creates the frame, sizes it, and centers it horizontally on
     the screen.
     */
    public GuiDemo() {
        super("Famous Quote"); // Specifies the string for the title bar of the window.
...
// Create the DrawPanel that fills most of the window, and customize it.
        ...
        drawPanel.getTextItem().setText(
                "I never think of missing a shot \n" + "becasue I haven't taken it yet\n" + "Micheal Jordan"
        );
        drawPanel.getTextItem().setFontSize(32);
...
// Add an icon toolbar to the NORTH position of the layout
...
// Create and customize the file chooser that is used for file operations.
        ...
        try { // I'd like to use the Desktop folder as the initial folder in the file chooser.
            String userDir = System.getProperty("User/Leon/Desktop");
            if (userDir != null) {
...
/*
 * Create toolbar for background
 */
private JToolBar makeToolbar() {
    JToolBar toolbar = new JToolBar("Background");
    JButton newPict = toolbar.add(newPictureAction);
    newPict.setToolTipText("Clear Image, return to default");
    JButton saveImg = toolbar.add(saveImageAction);
    ...
    private AbstractAction newPictureAction =
            new AbstractAction("New", Util.iconFromResource("resources/action_icons/file open.png")) {
                public void actionPerformed(ActionEvent evt) {
                    drawPanel.clear();
                    ...
                    if (f != null) {
                        try {
                            ...
                            if (fileName.endsWith(".png"))
                                ...
                                JOptionPane.showMessageDialog(drawPanel, "The output file name must end with\n.png or .jpeg.");
                                return;
                            }
...
private class ChooseBackgroundAction extends AbstractAction {
    ...
    ChooseBackgroundAction(String text) {
        ...
        if (text.equals("Color...")) {
            ...
            BufferedImage colorSel = new
                    BufferedImage(32,32,BufferedImage.TYPE_INT_RGB);
    ...
    public void actionPerformed(ActionEvent evt) {
        if (text.equals("Custom...")) {
            File inputFile = fileChooser.getInputFile(drawPanel,
            ...
            Image bg = Util.getImageResource("resources/images/" +
                    text.toLowerCase() + ".jpeg");
